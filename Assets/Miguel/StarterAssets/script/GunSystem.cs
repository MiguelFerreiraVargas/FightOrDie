...
public class GunElement : Element
{
    ...
    [SerializeField] private float _ammunation;//muni�ao total da arma para referencia pro jogador
    ...
    private float _ammunationClip;//Pente atual sendo utilizado at� ter que puxar mais
...
public class GunSystem : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!target.collider.TryGetComponent(out IShootable shootable))
            return;
        //Aciona o m�todo do contrato IShootable
